...
const Header = () => {
  ...
  return (
    <header className="header relative">
      <ImageNav menuIsActive={menuIsActive} items={categories} classes="w-full absolute left-0 top-[88px] lg:hidden bg-white md:h-[285px] z-[200] transform duration-1000 ease-in-out" mobileMenu="true" />
